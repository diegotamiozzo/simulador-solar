document.addEventListener('DOMContentLoaded', () => {
    ...
    function exibirSimulacao(data) {
        ...
        resultsDiv.innerHTML = `
           ...
           <ul>
            ...
            <button type="button" class="nav-btn" onclick="window.open('https://wa.me/48988131813?text=' + encodeURIComponent('Olá, fiz uma simulação gratuita e gostaria de tirar algumas dúvidas'), '_blank')">
    ...
    function enviarParaPlanilha(data) {
        ...
        fetch("https://script.google.com/macros/s/AKfycbzBQaglKUxuW6q3JeP_6qSTn17luE8hGbt_8DqWuM8WAEf6j4avur91K-s1UO6PSViY/exec", {
            method: "POST",
            mode: "no-cors",
            headers: {
